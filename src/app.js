...
//SHADER EDITOR ============================================
var fractal = CodeMirror($('#fractal-edit')[0], {
    lineNumbers: true,
    theme: 't-light'
});
var coloring = CodeMirror($('#color-edit')[0], {
    lineNumbers: true,
    theme: 't-light'
});
$('#shader').click(() => {
    frag.replace('INSERT FRACTAL HERE', fractal.getValue());
    frag.replace('INSERT COLOR HERE', coloring.getValue());
});
...
var cm = CodeMirror($('#fractal-edit')[0], {
    lineNumbers: true,
    theme: 't-light'
});
